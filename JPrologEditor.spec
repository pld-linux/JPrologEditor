Summary:	J Prolog Editor - an editor (written in Java) for SWI-Prolog
Summary(pl.UTF-8):	J Prolog Editor - edytor (napisany w Javie) dla języka SWI-Prolog
Name:		JPrologEditor
Version:	1.1
Release:	1
...
(www.swi-prolog.org) providing syntax highlighting, an embedded Prolog
interpreter and other features.

%description -l pl.UTF-8
J Prolog Editor to edytor (napisany w Javie) dla języka SWI-Prolog.
Obsługuję podświetlanie składni, posiada wbudowany interpreter Prologa
